...
class DemoUITestCase: UITestCase {
    ...
    func testBNewRecord()
    {
        ...
        app.textFields["Department"].clearAndEnterText(text:"Hardware")
        ...
        chooseDistanceAlert.pickerWheels.element(boundBy: 0).adjust(toPickerWheelValue: "CHINA")
        chooseDistanceAlert.buttons["Done"].tap()
        
        XCTAssertEqual(app.textFields["Country"] .value as! String, "CHINA") //check the value of textfield is equal to selected value from list
